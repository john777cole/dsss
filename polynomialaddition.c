...
void input(char p, int* start, int* finish); // function to input polynomial
void output(char p, int start, int finish); // function to print polynomial
int compare(int a, int b); // function to compare two numbers
void attach(int ex, int co); // function to insert values into the polynomial array
void add(int startA, int finishA, int startB, int finishB, int* startS, int* finishS); // function to add two polynomials
